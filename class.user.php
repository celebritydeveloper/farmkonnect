...
{	
	...
	public function register($uname,$email,$upass,$code)
	{
		...
		{							
			$password = md5($upass);
			$stmt = $this->conn->prepare("INSERT INTO farmkonnect_members(userName,userEmail,userPass,tokenCode) 
	...
	public function login($email,$upass)
	{
		try
		{
			$stmt = $this->conn->prepare("SELECT * FROM farmkonnect_members WHERE userEmail=:email_id");
